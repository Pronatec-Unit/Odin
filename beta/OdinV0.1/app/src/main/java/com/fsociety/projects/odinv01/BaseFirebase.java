...
public class BaseFirebase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_base_firebase);
        ...
        Firebase novaRef = objetoRef.child("lista_masculinos");
...
listaNomes.setAdapter(adaptador);
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("BaseFirebase Page") // TODO: Define a title for the content shown.
